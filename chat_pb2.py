...
_CONVERSATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id_DEPRECATED', full_name='Conversation.id_DEPRECATED', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='Conversation.id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='participant', full_name='Conversation.participant', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='group_name', full_name='Conversation.group_name', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='message', full_name='Conversation.message', index=4,
...
_CONVERSATION.fields_by_name['id_DEPRECATED']._options = None
